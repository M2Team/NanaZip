...
[Files]
Source: "x64\NanaZip.ModernExperience.dll"; DestDir: {app}; DestName: "NanaZip.ModernExperience.x64.dll"; Flags: 64bit uninsrestartdelete; Check: IsX64OS
Source: "ARM64\NanaZip.ModernExperience.dll"; DestDir: {app}; DestName: "NanaZip.ModernExperience.ARM64.dll"; Flags: 64bit uninsrestartdelete; Check: IsArm64
...
Root: HKA; Subkey: "Software\Classes\CLSID\{#ShellextClsid}\InprocServer32"; ValueType: string; ValueData: "{app}\NanaZip.ModernExperience.x64.dll"; Flags: uninsdeletevalue uninsdeletekeyifempty; Check: IsX64OS
Root: HKA; Subkey: "Software\Classes\CLSID\{#ShellextClsid}\InprocServer32"; ValueType: string; ValueData: "{app}\NanaZip.ModernExperience.ARM64.dll"; Flags: uninsdeletevalue uninsdeletekeyifempty; Check: IsArm64
