...
static const UInt32 kLangIDs[] =
{
  ...
  IDX_SETTINGS_OPEN_DESTINATION_LOCATION,
  // , IDT_COMPRESS_MEMORY
};
...
bool CSettingsPage::OnInit()
{
  ...
  */
  ...
  CheckButton(IDX_SETTINGS_OPEN_DESTINATION_LOCATION,st.ExtractLocation);
...
LONG CSettingsPage::OnApply()
{
  if (_wasChanged)
  {
    ...
    st.ExtractLocation = IsButtonCheckedBool(IDX_SETTINGS_OPEN_DESTINATION_LOCATION);
...
bool CSettingsPage::OnButtonClicked(int buttonID, HWND buttonHWND)
{
  switch (buttonID)
  {
    ...
    */
    ...
    case IDX_SETTINGS_OPEN_DESTINATION_LOCATION:
